...
class Window extends VisualObject {
    ...
    public function createInputBox($x, $y, $label, $value = null, $hideMask=null, $color = null) {
        return $this->createObject('\cuif\InputBox', array(
            'x'        => $x,
            'y'        => $y,
            'label'    => $label,
            'value'    => $value,
    ...
    public function createLabelBox($x, $y, $value) {
        return $this->createObject('\cuif\LabelBox', array(
            'x'        => $x,
            'y'        => $y,
            'value'    => $value,
        ));
    ...
    public function createCheckBox($x, $y, $label, $checked = false) {
        return $this->createObject('\cuif\CheckBox', array(
            'x'        => $x,
            'y'        => $y,
            'label'    => $label,
            'checked'    => $checked,
    ...
    public function createButton($x, $y, $label, $onPress = null) {
        $vo = $this->createObject('\cuif\Button', array(
            'x'        => $x,
            'y'        => $y,
            'label'    => $label,
        ));
	...
	public function createListBox() {
		return $this->createObject('\cuif\ListBox');
	}
}